...
type ProfileLoader struct {
	...
	cache map[string]*model.Profile
...
func (l *ProfileLoader) LoadThunk(key string) func() (*model.Profile, error) {
	...
	if it, ok := l.cache[key]; ok {
		l.mu.Unlock()
		return func() (*model.Profile, error) {
			return it, nil
		}
	}
	if l.batch == nil {
...
func (l *ProfileLoader) LoadAll(keys []string) ([]*model.Profile, []error) {
	results := make([]func() (*model.Profile, error), len(keys))
...
func (l *ProfileLoader) unsafeSet(key string, value *model.Profile) {
	if l.cache == nil {
		l.cache = map[string]*model.Profile{}
	}
	l.cache[key] = value
}
...
func (b *profileLoaderBatch) keyIndex(l *ProfileLoader, key string) int {
